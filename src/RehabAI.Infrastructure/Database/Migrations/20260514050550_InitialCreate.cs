        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GuestSessionId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    UsageDate = table.Column<DateOnly>(type: "date", nullable: false),
                    MessageCount = table.Column<int>(type: "int", nullable: false),
                    TokenCount = table.Column<int>(type: "int", nullable: false),
                    CostAmount = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AutoConfirmEnabled = table.Column<bool>(type: "bit", nullable: false),
                    NoShowFeeEnabled = table.Column<bool>(type: "bit", nullable: false),
                    NoShowFeeAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Payments_ExactlyOneTarget", "((CASE WHEN [OrderId] IS NOT NULL THEN 1 ELSE 0 END) + (CASE WHEN [AppointmentId] IS NOT NULL THEN 1 ELSE 0 END) + (CASE WHEN [SubscriptionId] IS NOT NULL THEN 1 ELSE 0 END)) = 1");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HistoryRetentionDays = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Users_ActiveRequiresPasswordHash", "([Status] <> 4 OR [PasswordHash] IS NOT NULL)");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlanCodeSnapshot = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LinkedFromGuestSessionId = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PublicProfileApproved = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "DoctorCredentialDocuments",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DoctorProfileId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    MalwareScanStatus = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    StorageSkippedByPolicy = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorCredentialDocuments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DoctorCredentialDocuments_DoctorProfiles_DoctorProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoctorProfileId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MedicalServiceId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DoctorScheduleSlotId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    StartTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    EndTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CancellationReason = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SoftReservedUntil = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AiUsageDaily_GuestSessionId_UsageDate",
                table: "AiUsageDaily",
                columns: new[] { "GuestSessionId", "UsageDate" },
                unique: true,
                filter: "[GuestSessionId] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_AiUsageDaily_UserId_UsageDate",
                table: "AiUsageDaily",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorCredentialDocuments_DoctorProfileId",
                table: "DoctorCredentialDocuments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorScheduleSlots_DoctorProfileId_StartTime_EndTime",
                table: "DoctorScheduleSlots",
                columns: new[] { "DoctorProfileId", "StartTime", "EndTime" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DoctorServices_DoctorProfileId_MedicalServiceId",
                table: "DoctorServices",
                columns: new[] { "DoctorProfileId", "MedicalServiceId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserTokens_UserId_TokenType_TokenHash",
                table: "UserTokens",
